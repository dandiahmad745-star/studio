...
import { Coffee, Gift, LayoutDashboard, LogOut, MessageSquare, Settings, Users, FolderKanban, CalendarClock, Send, Briefcase, QrCode, Mail } from 'lucide-react';
...
const adminNavLinks = [
  ...
  { href: '/admin/messages', label: 'Messages', icon: Mail, notificationKey: 'messages'},
